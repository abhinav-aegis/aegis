...
# import httpx
# from backend.common.schemas.response_schema import IGetResponseBase, create_response
...
# ) -> IGetResponseBase:
#     """
#     Gets Weather by list of cities It does sequencial requests.
#     """
#     weather_list = []
#     for city in cities:
#         weather = await get_weather_async(city=city)
...
# ) -> IGetResponseBase:
#     """
#     Gets Weather by list of cities It it optimized to do concurrent requests (It is faster than sequencial endpoint)
#     """
