...
async def get_a_cached_response() -> IGetResponseBase[str | datetime]:
    ...
    """
    return create_response(data=datetime.now()) # type: ignore
...
#     )
#     return create_response(message="message", data=count) # type: ignore
...
#         end_time=datetime.combine(end_date, datetime.min.time()),
#     )
#     return create_response(message="", data=count) # type: ignore
